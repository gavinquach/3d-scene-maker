...
} from "./ViewportShadingSelectorStyled.ts";

const FarLeftButton: React.FC<IShelfButton> = ({ children, ...props }) => (
...
const FarRightButton: React.FC<IShelfButton> = ({ children, ...props }) => (
